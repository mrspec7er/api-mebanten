...
exports.store = async (req, res) => {
  ...
  const { email, phone, name, banten_id, choices_date, banten_option } =
    req.body;
...
exports.deliveryStore = async (req, res) => {
  ...
  try {
    ...
    const totalShippingCost = await getTotalShippingCost(
      address_id,
      banten_id,
      res
    );
    ...
    const cart = await Cart.create({
      ...
      banten_id: parseInt(banten_id),
      choices_date,
      shipping_cost: parseInt(totalShippingCost),
